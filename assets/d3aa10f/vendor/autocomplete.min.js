    ...
    return "string" == typeof t
      ? (this.each(function () {
          ...
          "destroy" == t &&
            ...
            o.data("autocomplete")
              ? o.attr("autocomplete", o.data("autocomplete"))
            ...
            (s.updateSC = function (t, o) {
              if (
                ...
                !t &&
                  (s.sc.show(),
                  s.sc.maxHeight ||
                    (s.sc.maxHeight = parseInt(s.sc.css("max-height"))),
                  s.sc.suggestionHeight ||
                    (s.sc.suggestionHeight = e(".autocomplete-suggestion", s.sc)
                      .first()
                      .outerHeight()),
                  s.sc.suggestionHeight))
              )
                if (o) {
                  ...
                  c + s.sc.suggestionHeight - s.sc.maxHeight > 0
                    ? s.sc.scrollTop(
                        c + s.sc.suggestionHeight + a - s.sc.maxHeight
                      )
                    : 0 > c && s.sc.scrollTop(c + a);
              ...
              function (t) {
                ...
                return (
                  (c || a.hasClass("autocomplete-suggestion")) &&
                    (s.val(c), o.onSelect(t, c, a), s.sc.hide()),
                  !1
                );
              }
            ),
              ...
              if ((40 == t.which || 38 == t.which) && s.sc.html()) {
                ...
                return (
                  c.length
                    ...
                    : ((a =
                        40 == t.which
                          ? e(".autocomplete-suggestion", s.sc).first()
                          : e(".autocomplete-suggestion", s.sc).last()),
                      s.val(a.addClass("selected").data("val"))),
                  s.updateSC(0, a),
                  !1
                );
