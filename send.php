...
// 取出欄位
$firstname = $fields_assoc['firstname'] ?? '';
$lastname = $fields_assoc['lastname'] ?? '';
$email = $fields_assoc['email'] ?? '';
$alternative_email = $fields_assoc['alternative_email'] ?? '';
$phone = $fields_assoc['phone'] ?? '';
$company = $fields_assoc['company'] ?? '';
$country = $fields_assoc['country'] ?? '';
$message = $fields_assoc['message'] ?? '';
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
          ...
          <tr>
            <td style="background:#222;color:#ffffff;padding:20px;">
              <h2 style="margin:0;font-size:20px;">【Contact Form Submission】</h2>
          ...
          <tr>
            <td style="padding:20px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="font-size:14px;color:#333;">
                ...
                <tr>
                  <td style="padding:8px 0;font-weight:bold;">Alternative Email</td>
                  <td style="padding:8px 0;">' . htmlspecialchars($alternative_email) . '</td>
                </tr>
          ...
          <tr>
            <td style="background:#f0f0f0;padding:15px;font-size:12px;color:#777;text-align:center;">
              This email was sent from perfect24123.com contact form.
            </td>
          </tr>
...
try {
    ...
    // 設定寄件者（網域的信箱）
    $mail->setFrom('service@perfect24123.com', 'perfect24123.com');
